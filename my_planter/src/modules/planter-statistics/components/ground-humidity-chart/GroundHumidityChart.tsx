...
import { getDataGroundHumidity } from './services/getDataGroundHumidity.ts';
import { useLocation } from 'react-router-dom';

export const GroundHumidityChart = () => {
    ...
    useEffect(() => {
        ...
        getDataGroundHumidity(location.state.info.id, updateData);
