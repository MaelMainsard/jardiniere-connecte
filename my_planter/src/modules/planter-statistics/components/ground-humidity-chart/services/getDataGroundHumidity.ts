...
export const getDataGroundHumidity = (id: string, updateAirHumidity: (data: StatisticsTemplateInterface[]) => void) => {
  const planterRef = ref(db, `/plenters/${id}/ground-humidity/data`);
